...
final public class ProcessUtil {
   ...
   public static List<JCTree.JCVariableDecl> getJCVariables(JCTree.JCClassDecl jcClass) {
     ...
     */
    public static List<JCTree.JCMethodDecl> getSetJCMethods(JCTree.JCClassDecl jcClass) {
     ...
     * @return 是否存在
     */
    public static boolean hasSetMethod(JCTree.JCVariableDecl jcVariable, JCTree.JCClassDecl jcClass) {
     ...
     * @return 是否存在
     */
    public static boolean hasGetMethod(JCTree.JCVariableDecl jcVariable, JCTree.JCClassDecl jcClass) {
     ...
     * @return set方法名
     */
    public static String fromPropertyNameToSetMethodName(String propertyName) {
     ...
     * @return get方法名
     */
    public static String fromPropertyNameToGetMethodName(String propertyName) {
