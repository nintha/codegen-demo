...
import top.nintha.anno.AllArgsConstructor;
...
@SupportedAnnotationTypes("top.nintha.anno.AllArgsConstructor")
        ...
        set.forEach(element -> {
            ...
            jcTree.accept(new TreeTranslator() {
                ...
                public void visitClassDef(JCTree.JCClassDecl jcClass) {
                    messager.printMessage(Diagnostic.Kind.NOTE, "@AllArgsConstructor process [" + jcClass.name.toString() + "], start");
                    ...
                    messager.printMessage(Diagnostic.Kind.NOTE, "@AllArgsConstructor process [" + jcClass.name.toString() + "], end");
                }
            });
        });
